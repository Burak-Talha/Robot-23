...
public class FieldConstants {
    ...
    public static final List<Target> RED_TARGETS = Arrays.asList(
                                                            ...
                                                            new Target(aprilTags.get(5).relativeTo(new Pose3d(0, 0.675, 0.238, new Rotation3d())), null, TargetType.GET, DesiredPosition.UP),
                                                            new Target(aprilTags.get(6).relativeTo(new Pose3d(0, -0.675, 0.238, new Rotation3d())), null, TargetType.GET, DesiredPosition.UP)
                                                            );
